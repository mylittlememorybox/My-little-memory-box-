      ...
      <div style={container}>
        ...
        <Section title="Οι πρώτες σου στιγμές">
          <TwoCols
            ...
            right={
              <Photo
                src="/preview/newborn.jpg.JPG?v=4"
                alt="Νεογέννητο"
                height={320}
              />
            }
        ...
        <Section title="Ο κόσμος σου">
          <TwoCols
            ...
            right={
              <Stack>
                <Photo
                  src="/preview/family.jpg.JPG?v=4"
                  alt="Οικογένεια"
                  height={150}
                />
                <Photo
                  src="/preview/grandparents.jpg.JPG?v=4"
                  alt="Παππούδες"
                  height={150}
                />
              </Stack>
        ...
        <Section title="Οι πρώτες σου ανακαλύψεις">
          <TwoCols
            ...
            right={
              <Stack>
                <Photo
                  src="/preview/smile.jpg.JPG?v=4"
                  alt="Χαμόγελο"
                  height={150}
                />
                <Photo
                  src="/preview/crowl.jpg.jpg?v=4"
                  alt="Μπουσούλημα"
                  height={150}
                />
              </Stack>
        ...
        <Section title="Οι στιγμές που με έκανες να νιώθω τα πάντα">
          <TwoCols
            ...
            right={
              <Photo
                src="/preview/happy%20moment.jpg.JPG?v=4"
        ...
        <Section title="Για τα γενέθλιά σου">
          <TwoCols
            ...
            right={
              <Photo
                src="/preview/birthday.jpg.JPG?v=4"
                alt="Γενέθλια"
                height={320}
              />
            }
        ...
        <Section title="Τα πρώτα σου βήματα προς τον κόσμο">
          <TwoCols
            ...
            right={
              <Photo
                src="/preview/social.jpg.jpg?v=4"
                alt="Παιχνίδι με παιδάκια"
                height={320}
              />
            }
          />
        ...
        <Section title="Η πρώτη σου μέρα στο σχολείο">
          <TwoCols
            ...
            right={
              <Photo
                src="/preview/school.jpg.JPG?v=4"
        ...
        <Section title="Το παραμύθι σου">
          ...
          />
          <StoryBlock
            src="/preview/story3.jpg.PNG?v=4"
          ...
          />
          <StoryBlock
            src="/preview/story4.jpg.PNG?v=4"
          ...
          />
          <StoryBlock
            src="/preview/story5.jpg.PNG?v=4"
